...
submitButton.addEventListener("click", async () => {
    ...
    if (!password) {
        resultsDiv.innerHTML = '<p style="color: red;">Please enter the password.</p>';
        return;
    }

    if (links.length === 0) {
        resultsDiv.innerHTML = '<p style="color: red;">Please enter at least one YouTube Music link.</p>';
        return;
    }
